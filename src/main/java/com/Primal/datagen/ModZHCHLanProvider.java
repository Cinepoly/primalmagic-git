...
public class ModZHCHLanProvider extends FabricLanguageProvider {
    protected ModZHCHLanProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
        super(dataOutput,"zh_ch", registryLookup);
    }
