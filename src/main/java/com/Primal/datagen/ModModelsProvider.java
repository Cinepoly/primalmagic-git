...
public class ModModelsProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        // 六面不同
        generator.register(ModBlocks.MAGIC_BINDING_TABLE, context -> {
            TextureMap textures = new TextureMap()
                    ...
                    .put(TextureKey.BACK, Identifier.of("primalmagic", "block/magic_binding_table_back"))
                    .put(TextureKey.TOP, Identifier.of("primalmagic", "block/magic_binding_table_top"))
                    .put(TextureKey.BOTTOM, Identifier.of("primalmagic", "block/magic_binding_table_bottom"));
            Identifier modelId = Models.CUBE.upload(context, textures, generator.modelCollector);
            return BlockStateModelGenerator.createSingletonBlockState(context, modelId, textures);
        });
    }
